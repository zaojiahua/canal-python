...
class Client(object):
    ...
    def connect(self, host='127.0.0.1', port=11111):
        ...
        if packet.type != CanalProtocol_pb2.HANDSHAKE:
    ...
    def check_valid(self, username=b'', password=b''):
        ...
        packet = CanalProtocol_pb2.Packet()
        packet.type = CanalProtocol_pb2.CLIENTAUTHENTICATION
        ...
        packet = CanalProtocol_pb2.Packet()
        packet.MergeFromString(data)
        if packet.type != CanalProtocol_pb2.ACK:
    ...
    def subscribe(self, client_id=b'1001', destination=b'example', filter=b'.*\\..*'):
        ...
        packet = CanalProtocol_pb2.Packet()
        packet.type = CanalProtocol_pb2.SUBSCRIPTION
    ...
    def get_without_ack(self, batch_size=10, timeout=-1, unit=-1):
        ...
        packet = CanalProtocol_pb2.Packet()
        packet.type = CanalProtocol_pb2.GET
        ...
        if packet.type == CanalProtocol_pb2.MESSAGES:
        ...
        elif packet.type == CanalProtocol_pb2.ACK:
            ack = CanalProtocol_pb2.Ack()
            ack.MergeFromString(packet.body)
            if ack.error_code > 0:
    ...
    def ack(self, message_id):
        if message_id:
            ...
            packet = CanalProtocol_pb2.Packet()
            packet.type = CanalProtocol_pb2.CLIENTACK
    ...
    def rollback(self, batch_id):
        ...
        packet = CanalProtocol_pb2.Packet()
        packet.type = CanalProtocol_pb2.CLIENTROLLBACK
